...
def parse_arguments():
    ...
    parser.add_argument("--gpu_idx", action="store", type=str,
                        default='cuda:3',
    ...
    parser.add_argument("--images_dir", action="store", type=str,
                        default="/mnt/disk1/yunseob/Pytorch/0_Personal/0_data/celeba/img_align_celeba",
...
def main(args):
    ...
    device = th.device("{}".format(args.gpu_idx) if th.cuda.is_available() else "cpu")
...
cd '/mnt/disk1/yunseob/Pytorch/0_Personal/3_CelebA/2_GAN/b)_MSG_GAN'

python3 train.py --gpu_idx 'cuda:6' --start 4 --num_epochs 10 --generator_file 'models/1/GAN_GEN_3.pth' --generator_optim_file 'models/1/GAN_GEN_OPTIM_3.pth' --shadow_generator_file 'models/1/GAN_GEN_SHADOW_3.pth' --discriminator_file 'models/1/GAN_DIS_3.pth' --discriminator_optim_file 'models/1/GAN_DIS_OPTIM_3.pth'

python3 train.py --gpu_idx 'cuda:6' --start 11 --num_epochs 50 --generator_file 'models/1/GAN_GEN_10.pth' --generator_optim_file 'models/1/GAN_GEN_OPTIM_10.pth' --shadow_generator_file 'models/1/GAN_GEN_SHADOW_10.pth' --discriminator_file 'models/1/GAN_DIS_10.pth' --discriminator_optim_file 'models/1/GAN_DIS_OPTIM_10.pth'

python3 train.py --gpu_idx 'cuda:6' --start 51 --num_epochs 200 --generator_file 'models/1/GAN_GEN_50.pth' --generator_optim_file 'models/1/GAN_GEN_OPTIM_50.pth' --shadow_generator_file 'models/1/GAN_GEN_SHADOW_50.pth' --discriminator_file 'models/1/GAN_DIS_50.pth' --discriminator_optim_file 'models/1/GAN_DIS_OPTIM_50.pth'

python3 train.py --gpu_idx 'cuda:6' --start 158 --num_epochs 200 --generator_file 'models/1/GAN_GEN_157.pth' --generator_optim_file 'models/1/GAN_GEN_OPTIM_157.pth' --shadow_generator_file 'models/1/GAN_GEN_SHADOW_157.pth' --discriminator_file 'models/1/GAN_DIS_157.pth' --discriminator_optim_file 'models/1/GAN_DIS_OPTIM_157.pth'
